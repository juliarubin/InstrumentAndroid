...
developed as a series of external event handler routines, e.g., button
click and application exit.  Given an Android application, the static
analysis classifies each statement that may invoke a connection call
as either {\it essential} or {\it non-essential}.  We begin with
definitions and our problem statement: 
...
runtime semantics. Our analysis is implemented in the Soot Java
...
Our static analysis over-approximates the runtime behaviors of the
