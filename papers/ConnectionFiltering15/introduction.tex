...
disabling these kinds of non-essential communications. Working with
...
Spotify, Pandora, CandyCrush, etc.), our investigation is driven by
the following research questions:

\begin{quote}
\noindent{\bf RQ1: How frequently does non-essential communication
  occur in widely used mobile applications?}
\end{quote}

\vspace{0.1in}
\noindent 
{\bf RQ1: How frequently does non-essential communication occur in real-life applications?}
...
%Intuitively, the failure handling
...
%This problem is orthogonal and complementary to that of identifying sensitive information flow, which was the focus of numerous earlier works. 
