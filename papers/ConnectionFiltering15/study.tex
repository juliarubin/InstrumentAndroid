...
\conclusion{To answer RQ1, we conclude that non-essential communication often occur in real-life applications: 
around 65\% of the triggered connection statements can be deemed non-essential.}
