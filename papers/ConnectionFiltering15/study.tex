...
\begin{tabular}{|l|C{1.0cm}|C{1.5cm}|C{1.7cm}|C{2.0cm}|}
\hline
\textbf{Applications} &
\textbf{jar size (MB)} &
...
\hline
%--------------------------------------------------------------------
air.com.sgn.cookiejam.gp      & 2.7 &   17 &  3  & 2   (66.7\%) \\ % &  1 (33.3\%) & - \\
com.crimsonpine.stayinline    & 3.2 &   15 &  2  & 2   (100.0\%)\\ % &  0 (0.0\%)  & - \\
com.emoji.Smart.Keyboard      &     &    3 &  3  & 2   (66.7\%) \\ % &  1 (33.3\%) & - \\
com.jb.emoji.gokeyboard      &     &   42 & 10  & 7   (70.0\%) \\ % &  3 (30.0\%) & - \\
com.pandora.android       & 5.7 &   57 & 12  & 9   (75.0\%) \\ % &  3 (25.0\%) & - \\
com.spotify.music       & 5.4 &   20 &  7  & 3   (42.9\%) \\ % &  4 (57.1\%) & - \\
com.twitter.android       & 5.9 &   21 &  4  & 3   (75.0\%) \\ % &  1 (25.0\%) & - \\
com.walmart.android       & 5.8 &   33 &  8  & 5   (62.5\%) \\ % &  3 (37.5\%) & - \\
net.zedge.android       & 6.5 &   37 &  8  & 4   (50.0\%) \\ % &  4 (50.0\%) & - \\
\hline
%--------------------------------------------------------------------
Average        & 5.0 & 27.2 & 6.3 & 4.1 (67.6\%) \\ % & 2.2 (32.4\%) & - \\
\hline
%--------------------------------------------------------------------
\end{tabular}
}% resizebox
