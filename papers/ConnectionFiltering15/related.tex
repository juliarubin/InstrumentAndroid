...
It also relies on  
%From a technical point of view, our work relies on %static application analysis for Android and on 
...
analysis and use some program heap abstraction (e.g., points-to
