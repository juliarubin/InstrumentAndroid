...
%\author{
%\alignauthor
%Julia Rubin\textsuperscript{1}, Michael I. Gordon\textsuperscript{1}, Nguyen Nguyen\textsuperscript{2}, and Martin Rinard\textsuperscript{1} \\
%      \affaddr{\textsuperscript{1}Massachusetts Institute of Technology}\\
%      \affaddr{\textsuperscript{2}Global InfoTek, Inc}\\
%}

\author{\IEEEauthorblockN{Julia Rubin\IEEEauthorrefmark{1},
Michael I. Gordon\IEEEauthorrefmark{1},
Nguyen Nguyen\IEEEauthorrefmark{4}
and Martin Rinard\IEEEauthorrefmark{1}}
\IEEEauthorblockA{\IEEEauthorrefmark{1}Massachusetts Institute of Technology, USA}
\IEEEauthorblockA{\IEEEauthorrefmark{4}Global InfoTek, Inc, USA}
\IEEEauthorblockN{mjulia@mit.edu, mgordon@mit.edu, nguyen@uwinsoftware.com, rinard@mit.edu}
}
...
shows that almost 70\% of the external communication made by top-popular
...
manner, we propose a highly precise and scalable static-analysis technique: it achieves 93\% precision and 60\% recall compared to the empirically determined ``ground truth'' and runs in a matter of
a few minutes.
Furthermore, disabling connections deemed non-essential by our technique leaves the delivered application experience completely intact in 30 out of the 47 applications, and further 12 work with only insignificant interference, as assessed by human evaluators. 
We conclude that our technique is effective for identifying and disabling non-essential communication and use it to analyze communication patters in the 500 top-popular applications from Google Play. 
\end{abstract}
