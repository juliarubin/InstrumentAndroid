...
\title{Unnecessary Information Releases in Mobile Applications}
...
\begin{abstract}
Abstract
%This paper aims at identifying and eliminating  ``hidden'' release of information in mobile applications that do not affect the observable application functionality. 
