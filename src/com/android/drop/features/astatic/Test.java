...
//			return;
		...
		for (final String fileName : apkFiles) {
			...
			// Run the analysis
			String androidJar = Constants.SOOT_ANDROID_PLATFORM;
//			if (timeout > 0)
//				runAnalysisTimeout(fullFilePath, androidJar);
//			else if (sysTimeout > 0)
//				runAnalysisSysTimeout(fullFilePath, androidJar);
//			else
